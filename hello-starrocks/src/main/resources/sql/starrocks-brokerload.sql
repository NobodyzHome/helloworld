...
# +-----+---------+---------+-----------------+------+--------+--------+------------+--------------+--------+-------+---------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
show load from mydb where label='load_log20';
...
explain analyze select * from mydb.realtime_delivery_invocation where dt = '2024-10-28' and apiName in ('deliveryMonitorToOperBp','deliveryMonitorCompleteOperBp');