...
# 查询近期在暂停队列中暂存过的查询
# +-------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------+-----+----------------------------------+------------------+-----------------+--------+
# |timestamp          |stmt                                                                                                                                                                                                                                  |pendingTimeMs|state|errorCode                         |planCpuCosts      |planMemCosts     |scanRows|
# +-------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------+-----+----------------------------------+------------------+-----------------+--------+
# |2025-01-17 17:39:59|/* ApplicationName=IntelliJ IDEA 2024.3.1.1 */ select uid,count(distinct name) from mydb.hello_world_source group by uId                                                                                                              |218          |ERR  |BIG_QUERY_SCAN_ROWS_LIMIT_EXCEEDED|133335611.99999997|45838061.99999999|0       |
# |2025-01-17 17:50:51|/* ApplicationName=IntelliJ IDEA 2024.3.1.1 */ select timestamp,stmt,pendingTimeMs,state,errorCode,memCostBytes,cpuCostNs from starrocks_audit_db__.starrocks_audit_tbl__ where timestamp>='2025-01-17 17:30:00' and pendingTimeMs>0  |10           |EOF  |                                  |7055.394448694926 |0                |80      |
# |2025-01-17 17:48:38|/* ApplicationName=IntelliJ IDEA 2024.3.1.1 */ select * from starrocks_audit_db__.starrocks_audit_tbl__ where timestamp>='2025-01-17 17:30:00' and pendingTimeMs>0                                                                    |229          |EOF  |                                  |24568.224925570525|0                |69      |
# |2025-01-17 17:50:52|SELECT @@session.tx_isolation                                                                                                                                                                                                         |1            |EOF  |                                  |0                 |0                |0       |
# +-------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------+-----+----------------------------------+------------------+-----------------+--------+
select timestamp,stmt,pendingTimeMs,state,errorCode,planCpuCosts,planMemCosts,scanRows from starrocks_audit_db__.starrocks_audit_tbl__ where timestamp>=now() - interval 30 minute and pendingTimeMs>0;