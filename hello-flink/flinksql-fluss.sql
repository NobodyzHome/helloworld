...
drop table mydb.hello_world_append;
...
INSERT INTO mydb.hello_world_pk VALUES
                                    (1, '张三', 25, 1, '2025-04-23'),
                                    (2, '李四', 30, 1, '2025-04-24'),
                                    (3, '王五', 28, 1, '2025-04-25'),
                                    (4, '赵六', 22, 0, '2025-04-26'),
                                    (5, '钱七', 35, 0, '2025-04-27'),
                                    (6, '孙八', 27, 1, '2025-04-28'),
                                    (7, '周九', 31, 0, '2025-04-29'),
                                    (8, '吴十', 29, 1, '2025-04-23'),
                                    (9, '郑十一', 24, 0, '2025-04-24'),
                                    (10, '王十二', 33, 1, '2025-04-25');