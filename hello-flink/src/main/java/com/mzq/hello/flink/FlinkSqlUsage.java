...
public class FlinkSqlUsage {
    ...
    public static void main(String[] args) {
        ...
        tableEnvironment.executeSql("create view student_teacher(stu_id,stu_name,stu_age,stu_birthday,tea_id,tea_name,tea_age,tea_level) as " +
                "select student.id,student.name,student.age,student.birthday,teacher.id,teacher.name,teacher.age,teacher.level from student join teacher on student.teacher_id=teacher.id" +
                "");
